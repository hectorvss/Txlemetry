...
import { TxlemetryAuthAside } from 'scenes/authentication/TxlemetryAuthAside'
...
function Login(): JSX.Element {
    ...
    const loginTitle = isEmailVerificationSent ? 'Check your email' : 'Access your Txlemetry workspace'
    ...
    return (
        <BridgePage
            view="login"
            fixedWidth={false}
            leftContainerContent={<TxlemetryAuthAside />}
