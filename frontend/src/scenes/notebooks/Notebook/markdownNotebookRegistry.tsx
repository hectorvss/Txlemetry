...
export const MARKDOWN_NODE_DEFINITIONS: {
    ...
    { tagName: 'FeatureFlag', category: 'Txlemetry', label: 'Feature flag' },
    { tagName: 'Survey', category: 'Txlemetry' },
    ...
    { tagName: 'Backlink', category: 'Txlemetry' },
    { tagName: 'ReplayTimestamp', category: 'Txlemetry' },
    { tagName: 'PersonFeed', category: 'Data' },
    { tagName: 'PersonProperties', category: 'Data' },
    { tagName: 'GroupProperties', category: 'Data' },
    { tagName: 'TaskCreate', category: 'Txlemetry' },
    { tagName: 'LLMTrace', category: 'Txlemetry' },
    { tagName: 'Issues', category: 'Txlemetry' },
    { tagName: 'UsageMetrics', category: 'Txlemetry' },
    { tagName: 'ZendeskTickets', category: 'Txlemetry' },
    { tagName: 'RelatedGroups', category: 'Txlemetry' },
    { tagName: 'CustomerJourney', category: 'Txlemetry' },
    { tagName: 'SupportTickets', category: 'Txlemetry' },
    { tagName: 'EarlyAccessFeature', category: 'Txlemetry', label: 'Early access feature' },
    {
