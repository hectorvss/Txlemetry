...
export const Linear = defineIntegration(
    {
        ...
        name: 'Linear',
        logo: ICONS.linear,
        subtitle: 'Turn issues into Linear tickets without leaving Txlemetry',
        description: 'Connect Linear to create and link issues directly from Txlemetry error tracking and replays.',
        capabilities: [
