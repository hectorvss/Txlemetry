...
export const Slack = defineIntegration(
    {
        ...
        subtitle: 'Bring Txlemetry into Slack — from scheduled reports to an AI agent that ships code',
        description:
            'Tag @Txlemetry in any Slack thread to draft pull requests, ship code changes, ask data questions, and run SQL — all without leaving Slack. You also get insights, dashboards, and alerts delivered straight to your channels.',
        capabilities: [
            'Tag @Txlemetry in a thread to draft pull requests and ship code changes',
            'Tag @Txlemetry to ask data questions and run SQL',
