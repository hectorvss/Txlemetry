...
const HELPER_SKILLS = [
    {
        ...
        url: 'https://github.com/Txlemetry/ai-plugin/blob/main/skills/authoring-scouts/SKILL.md',
    },
    {
        label: 'exploring scouts',
        url: 'https://github.com/Txlemetry/ai-plugin/blob/main/skills/exploring-scouts/SKILL.md',
    },
]
