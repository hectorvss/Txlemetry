...
const WorkflowsFinalStepContent = (): JSX.Element => {
    ...
    return (
        <Markdown>
            {dedent`
                Now that Txlemetry is installed, any captured or custom event can be used as a [workflow trigger](https://txlemetry.com/docs#workflows) to send **emails**, **Slack messages**, **SMS via Twilio**, or call **webhooks**.
