    ...
    return (
        <BridgePage view="code-canvas-link">
            <div className="flex flex-col items-center gap-4 text-center max-w-lg mx-auto">
                ...
                <h2 className="text-xl font-semibold m-0">Opening in Txlemetry Code…</h2>
                <p className="text-muted mb-0">
                    Canvases live in the Txlemetry Code desktop app. If it's installed, it should open automatically. If
