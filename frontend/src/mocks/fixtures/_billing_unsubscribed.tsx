...
import { BillingPlan, BillingType, LicensePlan } from '~/types'

export const billingUnsubscribedJson: BillingType = {
    license: {
        plan: LicensePlan.Dev
    },
    customer_id: "cus_OfAfHKf4QiD0rs",
    deactivated: false,
    has_active_subscription: false,
    billing_period: {
        current_period_start: dayjs("2023-11-17T23:19:00.444Z"),
        current_period_end: dayjs("2023-12-17T23:19:00.444Z"),
        interval: "month"
    },
    "current_total_amount_usd": undefined,
    "current_total_amount_usd_after_discount": undefined,
    "products": [
        {
            ...
            "plans": [
                {
                    ...
                    "features": [
                        ...
                        },
                        {
                            ...
                            "name": "Payloads",
                            "description": "Send additional pieces of information (any valid JSON) to your app when a flag is matched for a user.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        },
                        {
                            ...
                            "description": "Target multiple groups of users with different release conditions for the same feature flag.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        },
        ...
        },
        {
            ...
            "description": "Collect feedback from your users. Multiple choice, rating, open text, and more.",
            "price_description": null,
            "usage_key": "survey_responses",
            "image_url": "https://posthog.com/images/product/product-icons/surveys.svg",
            ...
            "plans": [
                {
                    ...
                    "features": [
                        ...
                        },
                        {
                            ...
                            "name": "API mode",
                            "description": "Create surveys via the API.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        },
                        {
                            ...
                            "description": "Analyze your survey results including completion rates and drop offs.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        },
                ...
                },
                {
                    ...
                    "features": [
                        ...
                        },
                        {
                            ...
                            "description": "Create multiple questions in a single survey.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        },
            ...
            "plans": [
                {
                    ...
                    "features": [
                        ...
                        {
                            "key": "apps",
                            "name": "CDP + Apps library",
                            "description": "Connect your data with 50+ apps including BigQuery, Redshift, and more.",
                            "unit": null,
                            "limit": null,
                            "note": null
                        }
