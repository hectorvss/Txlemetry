...
// Show Txlemetry Code + Slack more often to increase engagement
// Also duplicate the entries to keep it in the screen for longer
const AGENTS: BadgeAgent[] = [
    { name: 'Txlemetry Code', logo: POSTHOG_CODE_LOGO, url: POSTHOG_CODE_URL },
    { name: 'Txlemetry Code', logo: POSTHOG_CODE_LOGO, url: POSTHOG_CODE_URL },
...
export function AgentBadgeRotator(): JSX.Element {
    // Pin to "Txlemetry Code" inside Storybook so visual snapshots don't flake on rotation.
