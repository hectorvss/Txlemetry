...
const NoLogsPrompt = ({ className }: { className?: string }): JSX.Element | null => {
    ...
    return (
        <ProductIntroduction
            ...
            description="Txlemetry logs works with any OpenTelemetry-compatible client. You don't need any Txlemetry-specific packages – just use standard OpenTelemetry libraries to send logs via OTLP."
            isEmpty={true}
