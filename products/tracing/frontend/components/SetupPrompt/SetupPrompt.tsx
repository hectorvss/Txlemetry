...
const NoSpansPrompt = ({ className }: { className?: string }): JSX.Element | null => {
    ...
    return (
        <ProductIntroduction
            ...
            description="Txlemetry tracing works with any OpenTelemetry-compatible client. You don't need any Txlemetry-specific packages – just use standard OpenTelemetry libraries to send spans via OTLP."
            isEmpty={true}
