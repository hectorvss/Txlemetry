                                    ...
                                    contents: [
                                        {
                                            ...
                                            type: 'text',
                                            values: {
                                                text: '<p style="line-height: 140%;">Hello from Txlemetry!</p>',
                                                _meta: {
                                        ...
                                        },
                                        {
                                            ...
                                            values: {
                                                href: {
                                                    ...
                                                    values: { href: 'https://txlemetry.com', target: '_blank' },
                                                },
