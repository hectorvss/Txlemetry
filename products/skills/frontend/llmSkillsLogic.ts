...
export const SKILL_CATEGORY_TABS: SkillCategoryTab[] = [
    {
        ...
        label: 'Scouts',
        description:
            "Scouts — scheduled agents that scan your project and surface findings in your inbox. Includes Txlemetry's canonical scouts and any custom ones you author.",
    },
]
