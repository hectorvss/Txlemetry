...
const NoMetricsPrompt = ({ className }: { className?: string }): JSX.Element | null => {
    ...
    return (
        <ProductIntroduction
            ...
            description="Txlemetry metrics works with any OpenTelemetry-compatible client. You don't need any Txlemetry-specific packages – just use standard OpenTelemetry libraries to send metrics via OTLP."
            isEmpty={true}
